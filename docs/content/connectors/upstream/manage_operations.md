...
Let's say you have a BurpSuite tool, which is set up to scan five different repositories for vulnerabilities. Your Connector will take note of this organizational structure and set up **Records** to help you translate those separate repositories into DefectDojos Asset/Engagement/Test hierarchy.
...
To learn more about working with records and setting up mappings to Assets, see our guide to [Managing Records](../manage_records).
...
* DefectDojo will create an **Engagement** nested under the Asset specified in the **Record Mapping**. This Engagement will be called **Global Connectors**.
* The **Global Connectors** Engagement will track each separate Connector associated with the Asset as a **Test**.
...
To learn more about Assets, Engagements, Tests and Findings, see our [Asset Hierarchy Overview](/asset_modelling/os_hierarchy/product_hierarchy/).
