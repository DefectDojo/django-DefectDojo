---
title: "Set Up Sensei"
description: "Connect a GitHub App and onboard a repository for hosted scanning"
draft: false
audience: pro
weight: 2
---
...
Setting up Sensei has two parts: **connect a GitHub App** once per organization, then **onboard the repositories** you want to scan. You need a global **Maintainer** or **Owner** role to do this.
