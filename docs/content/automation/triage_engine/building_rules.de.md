...
- /de/automation/rules_engine_2/building_rules/
---
...
Öffnen Sie **Triage Engine > All Rules** und wählen Sie **New Rule**, oder öffnen Sie eine bestehende Regel zur Bearbeitung.
