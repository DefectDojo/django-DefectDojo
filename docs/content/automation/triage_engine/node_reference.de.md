...
- /de/automation/rules_engine_2/node_reference/
---
...
Triage Engine bringt 25 Knoten in vier Kategorien mit. Diese Seite dokumentiert sie alle.
...
| Einstellung | Standard | Hinweise |
|---------|---------|-------|
| **Titel** | `Triage Engine: {{ctx.rule_name}}` | Wird einmal für den gesamten Batch gerendert. |
