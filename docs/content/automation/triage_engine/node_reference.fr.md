...
- /fr/automation/rules_engine_2/node_reference/
---
...
Triage Engine est fourni avec 25 nœuds répartis en quatre catégories. Cette page les documente tous.
...
| Paramètre | Valeur par défaut | Remarques |
|---------|---------|-------|
| **Titre** | `Triage Engine: {{ctx.rule_name}}` | Généré une fois pour l'ensemble du lot. |
