...
- /it/automation/rules_engine_2/deliveries/
---
...
Ogni effetto collaterale in uscita prodotto da una regola corrisponde a una riga nel registro delle consegne. **Triage Engine > Consegne** le elenca.
