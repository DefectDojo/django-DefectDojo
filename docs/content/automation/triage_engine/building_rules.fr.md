...
- /fr/automation/rules_engine_2/building_rules/
---
...
Ouvrez **Triage Engine > All Rules** et choisissez **New Rule** (Nouvelle règle), ou ouvrez une règle existante pour la modifier.
