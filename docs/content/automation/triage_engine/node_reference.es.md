...
- /es/automation/rules_engine_2/node_reference/
---

<span style="background-color:rgba(242, 86, 29, 0.3)">Nota: Triage Engine es una función exclusiva de DefectDojo Pro.</span>

Triage Engine se distribuye con 25 nodos en cuatro categorías. Esta página los documenta todos.
...
Un nodo de salida depende de algo externo a la regla: un token de Slack, un webhook de Microsoft Teams, una configuración de JIRA, un conector con licencia. Cuando eso falta o está desactivado, el nodo no puede funcionar, y Triage Engine lo indica en tres momentos distintos en lugar de fallar en silencio:
...
| Setting | Default | Notes |
|---------|---------|-------|
| **Title** | `Triage Engine: {{ctx.rule_name}}` | Se renderiza una vez para todo el lote. |
