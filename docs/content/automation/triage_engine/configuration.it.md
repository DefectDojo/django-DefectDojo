...
- /it/automation/rules_engine_2/configuration/
---
...
Triage Engine viene configurato separatamente dal Rules Engine originale. I due motori non condividono alcuna impostazione: un'impostazione `DD_RULES_ENGINE_*` non influisce su Triage Engine e un'impostazione `DD_RULES_V2_*` non influisce sul motore originale.
...
Alcuni nodi di Triage Engine usano la configurazione di integrazione a livello di sistema invece della propria:
