...
weight: 1
aliases:
  - "/import_data/import_intro/import_vs_reimport/"
...
* Via **Connectors** for certain tools, an ‘out of the box’ data integration: See [Connectors Guide](/connectors/upstream/about/)
