...
Engagements can be linked to a connected Jira Space, allowing Findings within the Engagement to be pushed to Jira as Issues. For a complete guide to setting up Jira, see **[Connecting DefectDojo to Jira](/connectors/os_jira/os__jira_guide/)**.
...
These settings are accessible from the **Edit Engagement** page. For more details, see **[Engagement-Level Jira Settings](/connectors/os_jira/os__jira_guide/#engagement-level-jira-settings)**.