...
By default, DefectDojo identifies duplicate Findings using the [hashcode deduplication algorithm](/triage_findings/finding_deduplication/about_deduplication/) with the following fields:
