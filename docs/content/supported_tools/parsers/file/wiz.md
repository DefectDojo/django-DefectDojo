...
<span style="background-color:rgba(242, 86, 29, 0.3)">⚠️ **DefectDojo Pro**</span> Users can also automatically create Findings directly from Wiz using the Wiz Connector.  See our [Connectors documentation](/connections/upstream/about/) for more details.
