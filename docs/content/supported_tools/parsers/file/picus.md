...
Picus findings deduplicate using the hashcode algorithm on a single stable [hashcode field](/triage_findings/finding_deduplication/about_deduplication/), the tool-native action identifier:
