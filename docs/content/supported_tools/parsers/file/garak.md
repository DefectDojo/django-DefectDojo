...
### Deduplication
The "Garak Scan" scan type uses the `hash_code` [deduplication algorithm](/triage_findings/finding_deduplication/about_deduplication/) with the following fields:
