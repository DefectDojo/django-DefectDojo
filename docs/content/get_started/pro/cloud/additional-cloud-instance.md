...
You can start this process from the following link: <https://cloud.defectdojo.com/onboarding>, or by clicking 🛒 **New Subscription** from the Cloud Manager page (cloud.defectdojo.com).
