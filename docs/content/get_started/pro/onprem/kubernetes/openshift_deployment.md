...
audience: pro
aliases:
  - /get_started/pro/onprem/openshift_deployment/
---
...
Where outbound traffic goes through a proxy rather than direct, see [Running DefectDojo Behind a Forward HTTPS Proxy](/get_started/pro/onprem/forward_proxy/).
