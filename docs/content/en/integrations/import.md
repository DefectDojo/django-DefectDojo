...
### SecureCodeBox Findings Import

Imports Findings generated by the [secureCodeBox](https://github.com/secureCodeBox/secureCodeBox). The format of the Findings is documented [here](https://docs.securecodebox.io/docs/api/finding).

The secureCodeBox integrates this parser to [automatically import scans](https://docs.securecodebox.io/docs/hooks/defectdojo) into DefectDojo.

To perform Scans with secureCodeBox, see this [Tutorial](https://docs.securecodebox.io/docs/getting-started/first-scans).
