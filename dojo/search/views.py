...
def simple_search(request):
    ...
    if request.method == "GET":
        ...
        if form.is_valid():
            ...
            # TODO better get findings in their own query and match on id.
            # \ that would allow filtering on additional fields such prod_id, etc.
            ...
            if search_finding_id:
                ...
                # setting initial values for filters is not supported and discouraged: \
...
def vulnerability_id_fix(keyword):
    ...
    # problem still remains for other case, i.e. searching for \
    # "valentijn-scholten" will return no results because of the hyphen.
    # see:
