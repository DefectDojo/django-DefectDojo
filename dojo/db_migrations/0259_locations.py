# Generated by Django 5.2.9 on 2026-01-31 18:31
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name="url",
            constraint=models.UniqueConstraint(django.db.models.functions.text.Lower("protocol"), models.F("user_info"), django.db.models.functions.text.Lower("host"), models.F("port"), models.F("path"), models.F("query"), models.F("fragment"), models.F("host_validation_failure"), name="url_unique"),
        ),
        pgtrigger.migrations.AddTrigger(
            model_name="url",
