...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sonarqube_project_key',
                 models.CharField(blank=True, max_length=200, null=True, verbose_name='SonarQube Project Key')),
                ...
                ('sonarqube_tool_config',
                 models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
                                   to='dojo.Tool_Configuration', verbose_name='SonarQube Configuration')),
            ],
        ),
        migrations.CreateModel(
            name='Sonarqube_Issue',
            fields=[
                ('key', models.CharField(help_text='SonarQube issue key', max_length=30, primary_key=True, serialize=False)),
        ...
        migrations.AddField(
            model_name='finding',
            name='sonarqube_issue',
            field=models.OneToOneField(blank=True, help_text='SonarQube issue', null=True, on_delete=django.db.models.deletion.CASCADE, to='dojo.Sonarqube_Issue'),
        ),
    ]
