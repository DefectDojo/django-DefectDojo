        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "url",
                    models.URLField(
                        help_text="For configuring Jira, view: https://defectdojo.readthedocs.io/en/latest/features.html#jira-integration",
                        max_length=2000,
                ...
                (
                    "open_status_key",
                    models.IntegerField(
                        help_text=b"To obtain the 'open status key' visit https://<YOUR JIRA URL>/rest/api/latest/issue/<ANY VALID ISSUE KEY>/transitions?expand=transitions.fields"
                    ),
                ),
                (
                    "close_status_key",
