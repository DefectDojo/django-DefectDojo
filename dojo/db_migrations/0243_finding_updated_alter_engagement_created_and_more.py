# Generated by Django 5.1.11 on 2025-08-28 22:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, help_text='Time that the object was initially created, and saved to the database', null=True, verbose_name='Created')),
                ('updated', models.DateTimeField(auto_now=True, help_text='Time that the object was most recently saved to the database', null=True, verbose_name='Updated')),
                ('status', models.CharField(choices=[('Vulnerable', 'Vulnerable'), ('NotVulnerable', 'Not Vulnerable')], default='NotVulnerable', help_text='The status of the the given Location', max_length=16, validators=[dojo.base_models.validators.validate_not_empty], verbose_name='Status')),
