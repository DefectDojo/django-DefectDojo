...
urlpatterns = [
    url(r'^webhook/(?P<secret>[\w-]+)$', views.webhook, name='web_hook'),
    url(r'^webhook/', views.webhook, name='web_hook'),
    url(r'^jira/webhook/(?P<secret>[\w-]+)$', views.webhook, name='web_hook'),
    url(r'^jira/webhook/', views.webhook, name='web_hook'),
