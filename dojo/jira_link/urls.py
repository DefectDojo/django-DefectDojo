...
urlpatterns = [
    re_path(
        r"^webhook/(?P<secret>[\w-]+)$", views.webhook, name="web_hook_secret"
    ),
    re_path(r"^webhook/", views.webhook, name="web_hook"),
    re_path(
        r"^jira/webhook/(?P<secret>[\w-]+)$",
        views.webhook,
        name="jira_web_hook_secret",
    ),
    ...
    re_path(
        r"^jira/(?P<tid>\d+)/delete$", views.delete_jira, name="delete_jira"
    ),
