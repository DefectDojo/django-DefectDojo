...
class Command(BaseCommand):
    for each_var in HASHCODE_FIELDS_PER_SCANNER:
        for each_ind in each_var:
		    ...
		    "compute_hash_code - configuration error: some elements of HASHCODE_FIELDS_PER_SCANNER are not in the allowed list HASHCODE_ALLOWED_FIELDS. " "Using default fields")
