    ...
    def handle(self, *args, **options):
        ...
        with connection.cursor() as cursor:
            ...
            for table in survey_tables:
                ...
                if (
                    new_table_name == "dojo_question"
                    or new_table_name == "dojo_answer"
                ):
                    update_string = (
                        "UPDATE `"
                        + new_table_name
                ...
                # Drop the ddse table
            print(
                "All defectDojo_engagement_sruvey tables migrated to dojo tables"
            )
