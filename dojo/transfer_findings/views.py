...
from dojo.forms import DeleteTransferFindingForm
...
class DeleteFinding(View):
    ...
    def post(self, request: HttpRequest, transfer_finding_id):
        transfer_finding = self.get_transfer_finding(transfer_finding_id)
