...
class UserHasImportPermission(permissions.BasePermission):
    def has_permission(self, request, view):
        ...
        _, _, _, engagement_id, engagement_name, product_name, product_type_name, auto_create_context, deduplication_on_engagement, do_not_reactivate = get_import_meta_data_from_dict(request.data)
...
class UserHasMetaImportPermission(permissions.BasePermission):
    def has_permission(self, request, view):
        ...
        _, _, _, _, _, product_name, _, _, _, _ = get_import_meta_data_from_dict(request.data)
...
class UserHasReimportPermission(permissions.BasePermission):
    def has_permission(self, request, view):
        ...
        test_id, test_title, scan_type, _, engagement_name, product_name, product_type_name, auto_create_context, deduplication_on_engagement, do_not_reactivate= get_import_meta_data_from_dict(request.data)
