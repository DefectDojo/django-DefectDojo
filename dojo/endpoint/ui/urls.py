...
from dojo.endpoint.ui import views
...
urlpatterns = [
    ...
    re_path(r"^endpoint/(?P<eid>\d+)/add_meta_data$", views.manage_meta_data,
        name="add_endpoint_meta_data"),
    re_path(r"^endpoint/(?P<eid>\d+)/edit_meta_data$", views.manage_meta_data,
