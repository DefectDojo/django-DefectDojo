...
def add_group_member(request, gid):
    ...
    if request.method == "POST":
        groupform = Add_Group_MemberForm(
    ...
    return render(
        request,
        "dojo/new_group_member.html",
        {"group": group, "form": groupform},
    )
...
def edit_group_member(request, mid):
    ...
    add_breadcrumb(
        title="Edit a Group Member", top_level=False, request=request
    )
    return render(
        request,
        "dojo/edit_group_member.html",
        {"memberid": mid, "form": memberform},
    )
...
def add_product_type_group(request, gid):
    ...
    add_breadcrumb(
        title="Add Product Type Group", top_level=False, request=request
    )
    return render(
        request,
