...
urlpatterns = [
    #  findings
    re_path(
        r"^finding$", views.open_findings, {"view": "All"}, name="all_findings"
    ),
    re_path(
        r"^finding/bulk$",
    ...
    re_path(
        r"^finding/closed$", views.closed_findings, name="closed_findings"
    ),
    re_path(
        r"^finding/accepted", views.accepted_findings, name="accepted_findings"
    ),
    re_path(
        r"^finding/(?P<fid>\d+)$", views.view_finding, name="view_finding"
    ),
    re_path(
        r"^finding/(?P<fid>\d+)/edit$", views.edit_finding, name="edit_finding"
    ),
    re_path(
        r"^finding/(?P<fid>\d+)/touch",
        views.touch_finding,
        name="touch_finding",
    ),
    re_path(
    ...
    re_path(
        r"^finding/(?P<fid>\d+)/delete$",
        views.delete_finding,
        name="delete_finding",
    ),
    re_path(
        r"^finding/(?P<fid>\d+)/copy$", views.copy_finding, name="copy_finding"
    ),
    re_path(
    ...
    re_path(
        r"^template/(?P<tid>\d+)/edit$",
        views.edit_template,
        name="edit_template",
    ),
    re_path(
        r"^template/(?P<tid>\d+)/delete",
