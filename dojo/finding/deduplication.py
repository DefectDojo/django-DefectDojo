...
def get_finding_models_for_deduplication(finding_ids):
    ...
    return list(
        ...
        .prefetch_related(
            # TODO: adopt location_prefetch_lookups() here once #15508 lands; that PR fixes the
            # crash this prefetch causes under V3 and re-baselines the perf query counts for it.
            "endpoints",
