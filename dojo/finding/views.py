...
ACCEPTED_FINDINGS_QUERY = Q(risk_acceptance__isnull=False) & Q(risk_acceptance__expiration_handled_date__isnull=True)
NOT_ACCEPTED_FINDINGS_QUERY = Q(risk_acceptance__isnull=True) | Q(risk_acceptance__expiration_handled_date__isnull=False)
WAS_ACCEPTED_FINDINGS_QUERY = Q(risk_acceptance__isnull=False) & Q(risk_acceptance__expiration_handled_date__isnull=False)
