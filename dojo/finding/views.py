...
class BaseListFindings:
    ...
    # def get_exclude_red_team_tag(self, filtered_findings_qs, user, product):
    #     if (
    #         user_has_exclusive_permission_product(
...
class ListFindings(View, BaseListFindings):
    ...
    def get(self, request: HttpRequest, product_id: Optional[int] = None, engagement_id: Optional[int] = None):
        ...
        filtered_findings_qs = get_exclude_red_team_tag(
            filtered_findings_qs=filtered_findings_qs,
            user=request.user)
...
class ViewFinding(View):
    ...
    # def get_filter_exclusive_permission_red_team(self,
    #                                              filtered_findings_qs,
    #                                              product,
    #                                              user=None):

    #     if settings.ENABLE_EXCLUSIVE_PERMISSION_RED_TEAM:
    #         filtered_findings_qs = get_exclude_red_team_tag(
    #             filtered_findings_qs=filtered_findings_qs,
    #             product=product,
    #             user=user)
