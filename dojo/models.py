...
class Engagement(models.Model):
    ...
    deduplication_on_engagement = models.BooleanField(default=False, verbose_name="Deduplication inside this engagement only", help_text="If enabled deduplication will only mark a finding in this engagement as duplicate of another finding if both findings are in this engagement. If disabled, deduplication is on the product level.")
