...
class UserContactInfo(models.Model):
    user = models.OneToOneField(Dojo_User, on_delete=models.CASCADE, db_column='user_id')
...
class ScanSettings(models.Model):
    ...
    user = models.ForeignKey(Dojo_User, editable=False, on_delete=models.CASCADE, db_column='user_id')
...
class Endpoint_Status(models.Model):
    ...
    mitigated_by = models.ForeignKey(Dojo_User, editable=True, null=True, on_delete=models.CASCADE)
...
class FindingImageAccessToken(models.Model):
    ...
    authentication"""
    user = models.ForeignKey(Dojo_User, null=False, blank=False, on_delete=models.CASCADE, db_column='user_id')
...
class Notifications(models.Model):
    ...
    user = models.ForeignKey(Dojo_User, default=None, null=True, editable=False, on_delete=models.CASCADE, db_column='user_id')
...
class Languages(models.Model):
    ...
    product = models.ForeignKey(Product, on_delete=models.CASCADE)
    user = models.ForeignKey(Dojo_User, editable=True, blank=True, null=True, on_delete=models.CASCADE, db_column='user_id')
...
class App_Analysis(models.Model):
    product = models.ForeignKey(Product, on_delete=models.CASCADE)
    name = models.CharField(max_length=200, null=False)
    user = models.ForeignKey(Dojo_User, editable=True, on_delete=models.CASCADE, db_column='user_id')
