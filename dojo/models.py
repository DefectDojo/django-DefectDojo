...
class JIRA_Instance(models.Model):
    ...
    username = models.CharField(max_length=2000, verbose_name=_("Username/Email"), help_text=_("Username or Emailaddress, see DefectDojo documentation for more information."))
