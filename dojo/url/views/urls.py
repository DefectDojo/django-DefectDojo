...
from dojo.url.views import views
...
urlpatterns = [
    ...
    re_path(r"^endpoint/(?P<location_id>\d+)$", views.view_endpoint,
        name="view_endpoint"),
    re_path(r"^endpoint/host/(?P<location_id>\d+)$", views.view_endpoint_host,
