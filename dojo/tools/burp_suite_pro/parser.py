        ...
        for issue_event in tree.get('issue_events', list()):
            if "issue_found" == issue_event.get("type"):
                ...
                finding = Finding(title=title,
                                    ...
                                    unique_id_from_tool=str(issue_event['issue']['serial_number']),  # the serial number is a good candidate for this attribute
                                    vuln_id_from_tool=str(issue_event['issue']['type_index'])  # the type index is a good candidate for this attribute
                                )
