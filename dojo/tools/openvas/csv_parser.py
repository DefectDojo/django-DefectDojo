...
class OpenVASCSVParser:
    def create_chain(self):
        ...
        cvss_column_strategy = CvssColumnMappingStrategy()
        ...
        cvss_column_strategy.successor = severity_column_strategy
        ip_column_strategy.successor = cvss_column_strategy
