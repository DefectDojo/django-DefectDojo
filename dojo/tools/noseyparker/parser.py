...
class NoseyParkerParser:
    ...
    def version_0_16_0(self, line, test):
        ...
        for match in line["matches"]:
            ...
            key = hashlib.md5((filepath + "|" + secret + "|" + str(line_num)).encode("utf-8")).hexdigest()  # noqa: S324
    ...
    def version_0_22_0(self, line, test):
        ...
        for match in line["matches"]:
            ...
            # Internal de-duplication
            key = hashlib.md5((filepath + "|" + rule_text_id + "|" + str(line_num)).encode("utf-8")).hexdigest()  # noqa: S324
