...
class JIRATemplatetTest(DojoTestCase):
    ...
    def test_get_jira_issue_template_dir_from_project(self):
        ...
        jira_project.issue_template_dir = 'issue-trackers/1-jira-description-limited.tpl'
        jira_project.save()

        self.assertEqual(jira_helper.get_jira_issue_template_dir(product), 'issue-trackers/1-jira-description-limited.tpl')
    ...
    def test_get_jira_issue_template_dir_from_instance(self):
        ...
        jira_project.save()
        self.assertEqual(jira_helper.get_jira_issue_template_dir(product), 'issue-trackers/jira_full/jira-description.tpl')
