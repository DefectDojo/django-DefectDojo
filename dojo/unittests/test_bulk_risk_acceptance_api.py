...
from dojo.models import Product_Type, Product, Engagement, Product_Type_Member, Test, Finding, User, Test_Type
...
class TestBulkRiskAcceptanceApi(APITestCase):
    ...
    def setUpTestData(cls):
        ...
        Product_Type_Member.objects.create(product_type=cls.product_type, user=cls.user, role=4)
