...
class TestJFrogXrayUnifiedParser(TestCase):
    ...
    def test_parse_file_with_one_vuln(self):
        ...
        self.assertEquals("pypi://Jinja2", item.component_name)
    ...
    def test_parse_file_with_very_many_vulns(self):
        ...
        self.assertIsNotNone(item.mitigation)
        self.assertGreater(len(item.mitigation), 0)
        self.assertEquals("go://github.com/docker/docker", item.component_name)
        ...
        self.assertIsNotNone(item.mitigation)
        self.assertGreater(len(item.mitigation), 0)
        self.assertEquals("npm://jquery", item.component_name)
        ...
        self.assertIsNotNone(item.mitigation)
        self.assertGreater(len(item.mitigation), 0)
        self.assertEquals("pypi://pip", item.component_name)
