...
class TestTFSecParser(TestCase):
    ...
    def test_parse_many_findings(self):
        ...
        with self.subTest(i=0):
            ...
            self.assertIsNotNone(finding.description)
            self.assertEqual("See https://tfsec.dev/docs/google/GCP008/ for more information.", finding.url)
            self.assertTrue(finding.active)
        ...
        with self.subTest(i=1):
            ...
            self.assertEqual("High", finding.severity)
            self.assertIsNotNone(finding.description)
            self.assertEqual("See https://tfsec.dev/docs/google/GCP009/ for more information.", finding.url)
            self.assertTrue(finding.active)
        ...
        with self.subTest(i=2):
            ...
            self.assertEqual("High", finding.severity)
            self.assertIsNotNone(finding.description)
            self.assertEqual("See https://tfsec.dev/docs/google/GCP010/ for more information.", finding.url)
            self.assertTrue(finding.active)
