...
class TestMeterianParser(TestCase):
    ...
    def test_meterianParser_report_has_one_findings(self):
        testfile = open("dojo/unittests/scans/meterian/report_one_vuln.json")
    ...
    def test_meterianParser_report_has_many_findings(self):
        testfile = open("dojo/unittests/scans/meterian/report_many_vulns.json")
    ...
    def test_meterianParser_finding_has_no_remediation(self):
        testfile = open("dojo/unittests/scans/meterian/report_one_vuln_no_remediation.json")
    ...
    def test_meterianParser_dual_language_report_has_two_findins(self):
        testfile = open("dojo/unittests/scans/meterian/report_multi_language.json")
