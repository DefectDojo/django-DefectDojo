...
class TestSecureCodeBoxParser(TestCase):
    ...
    def test_scb_parser_with_many_vuln_has_many_findings(self):
        ...
        self.assertIsNone(findings[0].unsaved_endpoints[0].path)
        self.assertIsNone(findings[0].unsaved_endpoints[0].query)
        self.assertIsNone(findings[0].unsaved_endpoints[0].fragment)
