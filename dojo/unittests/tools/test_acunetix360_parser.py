...
class TestAcunetix360Parser(TestCase):
    ...
    def test_parse_file_with_one_finding(self):
        testfile = open("dojo/unittests/scans/acunetix360/acunetix360_one_finding.json")
    ...
    def test_parse_file_with_multiple_finding(self):
        testfile = open("dojo/unittests/scans/acunetix360/acunetix360_many_findings.json")
        parser = Acunetix360Parser()
        findings = parser.get_findings(testfile, Test())
