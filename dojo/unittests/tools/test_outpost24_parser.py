...
class TestOutpost24Parser(TestCase):
    ...
    def test_parser_no_items(self):
        self.assert_file_has_n_items(path.join(path.dirname(__file__), "scans/outpost24/none.xml"), 0)

    def test_parser_one_item(self):
        self.assert_file_has_n_items(path.join(path.dirname(__file__), "scans/outpost24/one.xml"), 1)

    def test_parser_sample_items(self):
        self.assert_file_has_n_items(path.join(path.dirname(__file__), "scans/outpost24/sample.xml"), 24)
