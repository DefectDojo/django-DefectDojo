...
class TestScoutSuiteParser(TestCase):
    def test_scout_suite_parser_with_no_vuln_has_no_findings(self):
        test_file = open("dojo/unittests/scans/scout_suite/no_vuln.js")
        parser = ScoutSuiteParser()
        findings = parser.get_findings(test_file, Test())
        self.assertEqual(0, len(findings))

    def test_scout_suite_parser_with_two_findings(self):
        test_file = open("dojo/unittests/scans/scout_suite/two_findings.js")
        parser = ScoutSuiteParser()
        findings = parser.get_findings(test_file, Test())
    ...
    def test_get_findings(self):
        test_file = open("dojo/unittests/scans/scout_suite/new2.js")
        parser = ScoutSuiteParser()
        findings = parser.get_findings(test_file, Test())
