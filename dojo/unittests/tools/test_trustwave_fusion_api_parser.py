...
class TestTrustwaveFusionAPIParser(TestCase):
    ...
    def test_parse_file_with_no_vuln_has_no_findings(self):
        testfile = open("dojo/unittests/scans/trustwave_fusion_api/trustwave_fusion_api_zero_vul.json")
    ...
    def test_vuln_with_valid_cve(self):
        ...
        self.assertEqual("Vulnerability/Missing Patch; CVEs: CVE-2017-7529",
            finding.description)

        finding = findings[1]
        self.assertEqual(2566, finding.cve)  # We use the first cve
        self.assertEqual("Cryptography/Weak Cryptography; CVEs: CVE-2013-2566, CVE-2015-2808",
            finding.description)

    def test_parse_file_with_multiple_vuln_has_multiple_findings(self):
        testfile = open("dojo/unittests/scans/trustwave_fusion_api/trustwave_fusion_api_many_vul.json")
        parser = TrustwaveFusionAPIParser()
        findings = parser.get_findings(testfile, Test())
        ...
        self.assertEqual("Information/Service Discovery; CVEs: no match", finding.description)
