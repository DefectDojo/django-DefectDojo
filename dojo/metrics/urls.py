...
urlpatterns = [
    ...
    re_path(r'^metrics/product/refresh',
            views.ajax_product_refresh, name='ajax_product_refresh'),
    re_path(r'^metrics/product/type/refresh',
            views.ajax_product_type_refresh, name='ajax_product_type_refresh'),
