...
urlpatterns = patterns(
    ...
    url(r'^$', 'dojo.views.dashboard', name='home'),
    ...
    url(r'^product_type$', 'dojo.views.product_type', name='product_type'),
    ...
    url(r'^launch_va/(?P<pid>\d+)$', 'dojo.views.launch_va',
        name='launch_va'),
    url(r'^engagements$', 'dojo.views.engagement', name='engagements'),
    ...
    url(r'^new_engagement$', 'dojo.views.new_engagement', name='new_eng'),
    url(r'^(?P<pid>\d+)/new_engagement$', 'dojo.views.new_eng_for_app',
        name='new_eng_for_app'),
    url(r'^(?P<pid>\d+)/edit_product$', 'dojo.views.edit_product',
        name='edit_product'),
