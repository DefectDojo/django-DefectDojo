...
urlpatterns = [
    ...
    # Temporary removal of reports
    url(r'^reports$',
        views.down, name='reports'),
    url(r'^reports/(?P<rid>\d+)/download$', views.down,
        name='download_report'),
    url(r'^reports/(?P<rid>\d+)/delete', views.down,
        name='delete_report'),
    url(r'^reports/(?P<rid>\d+)/status', views.down,
        name='report_status'),
    url(r'^reports/(?P<rid>\d+)/regen', views.down,
        name='regen_report'),
    url(r'^reports/(?P<rid>\d+)/revoke', views.down,
        name='revoke_report'),
    url(r'^reports/cover$',
        views.down, name='report_cover_page'),
    url(r'^reports/builder$',
        views.down, name='report_builder'),
    url(r'^reports/findings$',
        views.down, name='report_findings'),
    url(r'^reports/endpoints$',
        views.down, name='report_endpoints'),
    url(r'^reports/custom$',
        views.down, name='custom_report'),
    url(r'^reports/findings$',
        views.down, name='report_findings'),
    url(r'^reports/endpoints$',
        views.down, name='report_endpoints'),
