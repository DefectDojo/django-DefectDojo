...
urlpatterns = [
    ...
    url(r'^reports/scheduler$',
        views.report_scheduler, name='report_scheduler'),
    url(r'^reports/scheduler/add$',
        views.add_report_interval, name='add_report_interval'),
    url(r'^reports/scheduler/(?P<sid>\d+)/edit$',
        views.edit_report_interval, name='edit_report_interval'),
    url(r'^reports/scheduler/(?P<sid>\d+)/delete$',
        views.delete_report_interval, name='delete_report_interval'),
