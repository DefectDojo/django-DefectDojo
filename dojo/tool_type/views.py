...
@user_is_authorized_for_configuration('dojo.add_tool_type', 'superuser')
...
@user_is_authorized_for_configuration('dojo.change_tool_type', 'superuser')
...
@user_is_authorized_for_configuration('dojo.view_tool_type', 'superuser')
