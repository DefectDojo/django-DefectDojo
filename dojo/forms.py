...
class ImportScanForm(forms.Form):
    ...
    service = forms.CharField(max_length=200, required=False, help_text="A service is a self-contained piece of functionality within a Product. It is used in deduplication of findings.")
