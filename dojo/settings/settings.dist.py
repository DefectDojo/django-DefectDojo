...
HASHCODE_FIELDS_PER_SCANNER = {
    ...
    'AnchoreCTL JSON Report': ['title', 'severity', 'component_name', 'component_version', 'file_path'],
...
DEDUPLICATION_ALGORITHM_PER_PARSER = {
    ...
    'AnchoreCTL JSON Report': DEDUPE_ALGO_HASH_CODE,
