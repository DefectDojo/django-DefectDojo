...
class NumberValidator(object):
    def validate(self, password, user=None):
        if not re.findall("\d", password) and get_system_setting(
...
class UppercaseValidator(object):
    def validate(self, password, user=None):
        if not re.findall("[A-Z]", password) and get_system_setting(
...
class SymbolValidator(object):
    def validate(self, password, user=None):
        ...
        if not contains_special_character and get_system_setting(
