...
@user_is_authorized_for_configuration('auth.view_user', 'staff')
def user(request):
...
@user_is_authorized_for_configuration('auth.add_user', 'superuser')
...
@user_is_authorized_for_configuration('auth.delete_user', 'superuser')
