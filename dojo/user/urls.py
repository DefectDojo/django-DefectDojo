...
urlpatterns = [
    ...
    re_path(r"^alerts/count/text$", views.alertcount_text, name="alertcount_text"),
    re_path(r"^alerts/partial$", views.alerts_partial, name="alerts_partial"),
    ...
    re_path(r"^user/(?P<uid>\d+)/authorize_product_types$",
            views.authorize_user_for_product_types, name="authorize_user_for_product_types"),
    re_path(r"^user/(?P<uid>\d+)/revoke_product/(?P<pid>\d+)$",
