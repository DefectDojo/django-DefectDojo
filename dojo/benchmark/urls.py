...
urlpatterns = [
    ...
    re_path(r'^benchmark/(?P<pid>\d+)/type/(?P<_type>\d+)/update$', views.update_benchmark, name='update_product_benchmark'),
    re_path(r'^benchmark/(?P<pid>\d+)/type/(?P<_type>\d+)/summary/(?P<summary>\d+)/update$', views.update_benchmark_summary, name='update_product_benchmark_summary'),
]
