...
v3_urlpatterns = [
    ...
    re_path(r"^organization/(?P<ptid>\d+)$",
            views.view_product_type, name="view_product_type"),
    re_path(r"^organization/(?P<ptid>\d+)/edit$",
            views.edit_product_type, name="edit_product_type"),
    re_path(r"^organization/(?P<ptid>\d+)/delete$",
            views.delete_product_type, name="delete_product_type"),
    re_path(r"^organization/add$", views.add_product_type,
            name="add_product_type"),
    re_path(r"^organization/(?P<ptid>\d+)/add_asset",
            product_views.new_product,
            name="add_product_to_product_type"),
    re_path(r"^organization/(?P<ptid>\d+)/add_member$", views.add_product_type_member,
            name="add_product_type_member"),
    re_path(r"^organization/member/(?P<memberid>\d+)/edit$", views.edit_product_type_member,
            name="edit_product_type_member"),
    re_path(r"^organization/member/(?P<memberid>\d+)/delete$", views.delete_product_type_member,
            name="delete_product_type_member"),
    re_path(r"^organization/(?P<ptid>\d+)/add_group$", views.add_product_type_group,
            name="add_product_type_group"),
    re_path(r"^organization/group/(?P<groupid>\d+)/edit$", views.edit_product_type_group,
            name="edit_product_type_group"),
    re_path(r"^organization/group/(?P<groupid>\d+)/delete$", views.delete_product_type_group,
            name="delete_product_type_group"),
]


v2_backwards_urlpatterns = [
...
urlpatterns = common_urlpatterns + v3_urlpatterns + v2_backwards_urlpatterns
