...
def add_product_tests_to_suite(suite, *, jira=False, github=False, block_execution=False):
    ...
    suite.addTest(AssetTest("test_edit_product_description"))
    suite.addTest(AssetTest("test_add_technology"))
    suite.addTest(AssetTest("test_edit_technology"))
    suite.addTest(AssetTest("test_delete_technology"))
    suite.addTest(AssetTest("test_add_product_engagement"))
    suite.addTest(AssetTest("test_add_product_finding"))
    suite.addTest(AssetTest("test_add_product_endpoints"))
    suite.addTest(AssetTest("test_add_product_custom_field"))
    suite.addTest(AssetTest("test_edit_product_custom_field"))
    suite.addTest(AssetTest("test_add_product_tracking_files"))
    suite.addTest(AssetTest("test_edit_product_tracking_files"))
    suite.addTest(AssetTest("test_list_products"))
    suite.addTest(AssetTest("test_list_components"))
    suite.addTest(AssetTest("test_product_notifications_change"))
    suite.addTest(AssetTest("test_product_metrics"))

    # we add metrics tests here as we now have a product that triggers some logic inside metrics
    suite.addTest(AssetTest("test_critical_product_metrics"))
    suite.addTest(AssetTest("test_product_type_metrics"))
    suite.addTest(AssetTest("test_product_type_counts_metrics"))
    suite.addTest(AssetTest("test_simple_metrics"))
    suite.addTest(AssetTest("test_engineer_metrics"))
    suite.addTest(AssetTest("test_metrics_dashboard"))
