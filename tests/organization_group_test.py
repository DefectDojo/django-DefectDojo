...
class OrganizationGroupTest(BaseTestCase):
...
def suite():
    ...
    suite.addTest(OrganizationGroupTest("test_group_add_product_type_group"))
    suite.addTest(OrganizationGroupTest("test_group_edit_product_type_group"))
    suite.addTest(OrganizationGroupTest("test_group_delete_product_type_group"))
    suite.addTest(OrganizationGroupTest("test_product_type_add_product_type_group"))
    suite.addTest(OrganizationGroupTest("test_product_type_edit_product_type_group"))
    suite.addTest(OrganizationGroupTest("test_product_type_delete_product_type_group"))
