...
def suite():
    ...
    suite.addTest(OrganizationTest("test_create_product_type"))
    suite.addTest(OrganizationTest("test_view_product_type"))
    suite.addTest(OrganizationTest("test_create_product_for_product_type"))
    suite.addTest(OrganizationTest("test_edit_product_type"))
    suite.addTest(OrganizationTest("test_delete_product_type"))
    return suite
