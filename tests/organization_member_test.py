...
def suite():
    ...
    suite.addTest(OrganizationMemberTest("test_user_add_product_type_member"))
    suite.addTest(OrganizationMemberTest("test_user_edit_product_type_member"))
    suite.addTest(OrganizationMemberTest("test_user_delete_product_type_member"))
    suite.addTest(OrganizationMemberTest("test_product_type_add_product_type_member"))
    suite.addTest(OrganizationMemberTest("test_product_type_edit_product_type_member"))
    suite.addTest(OrganizationMemberTest("test_product_type_delete_product_type_member"))
