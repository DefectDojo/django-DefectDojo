...
We release very month on the last Tuesday, these release are minor releases, i.e. 2.0.0 to 2.1.0. In between there might be bugfix/hotfix/patch releases, i.e. 2.0.1 when needed.
