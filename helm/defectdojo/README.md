...
To install the chart with the release name `my-defectdojo`:

```sh
helm repo add defectdojo 'https://raw.githubusercontent.com/DefectDojo/django-DefectDojo/helm-charts'
helm repo update
# prepare my-values.yaml
helm install my-defectdojo -f my-values.yaml
```

## Uninstalling the Chart

```sh
helm uninstall my-defectdojo
```
...
After adding DefectDojo Helm chart (`helm repo add defectdojo ...` see [above](#installing)), you can check all available releases:

```sh
$ helm search repo defectdojo --versions     
NAME                            CHART VERSION   APP VERSION     DESCRIPTION                                     
defectdojo/defectdojo           1.8.0           2.52.0          A Helm chart for Kubernetes to install DefectDojo
defectdojo/defectdojo           1.7.3           2.51.3          A Helm chart for Kubernetes to install DefectDojo
defectdojo/defectdojo           1.7.2           2.51.2          A Helm chart for Kubernetes to install DefectDojo
defectdojo/defectdojo           1.7.1           2.51.1          A Helm chart for Kubernetes to install DefectDojo
defectdojo/defectdojo           1.7.0           2.51.0          A Helm chart for Kubernetes to install DefectDojo
defectdojo/defectdojo           1.6.209         2.50.4          A Helm chart for Kubernetes to install DefectDojo
defectdojo/defectdojo           1.6.208         2.50.3          A Helm chart for Kubernetes to install DefectDojo
defectdojo/defectdojo           1.6.207         2.50.2          A Helm chart for Kubernetes to install DefectDojo
defectdojo/defectdojo           1.6.206         2.50.1          A Helm chart for Kubernetes to install DefectDojo
defectdojo/defectdojo           1.6.205         2.50.0          A Helm chart for Kubernetes to install DefectDojo
...
```
...
3. Latest Helm repo of DefectDojo (see [_Installing_](#installing))
