...
#python manage.py test unittests.tools.test_rusty_hog_parser.TestRustyhogParser.test_parse_file_with_no_vuln_has_no_finding_gottingenhog --keepdb
class TestRustyhogParser(DojoTestCase):
    def test_parse_file_with_no_vuln_has_no_finding_choctawhog(self):
        ...
        findings = parser.get_findings(testfile, "Rusty Hog", Test()) # The outputfile is empty. A subscanner can't be classified
    ...
    def test_parse_file_with_one_vuln_has_one_finding_choctawhog(self):
        ...
        parser = RustyhogParser()
        findings = parser.get_findings(testfile, "Choctaw Hog", Test())
    ...
    def test_parse_file_with_one_vuln_has_one_finding_gottingenhog(self):
        ...
        parser = RustyhogParser()
        findings = parser.get_findings(testfile, "Gottingen Hog", Test())
        self.assertEqual(1, len(findings))
