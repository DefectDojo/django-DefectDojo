...
class TestRustyhogParser(DojoParserTestCase):
    ...
    def test_parse_file_with_no_vuln_has_no_finding_choctawhog(self):
        ...
        findings = self.parser.get_items(testfile, "Rusty Hog", Test())  # The outputfile is empty. A subscanner can't be classified
    ...
    def test_parse_file_with_one_vuln_has_one_finding_choctawhog(self):
        ...
        findings = self.parser.get_items(testfile, "Choctaw Hog", Test())
    ...
    def test_parse_file_with_one_vuln_has_one_finding_durochog(self):
        ...
        findings = self.parser.get_items(testfile, "Duroc Hog", Test())
        self.assertEqual(1, len(findings))
    ...
    def test_parse_file_with_one_vuln_has_one_finding_gottingenhog(self):
        ...
        findings = self.parser.get_items(testfile, "Gottingen Hog", Test())
        self.assertEqual(1, len(findings))
    ...
    def test_parse_file_with_one_vuln_has_one_finding_essexhog(self):
        ...
        findings = self.parser.get_items(testfile, "Essex Hog", Test())
        self.assertEqual(1, len(findings))
