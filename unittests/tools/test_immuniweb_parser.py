...
class TestImmuniwebParser(DojoTestCase):
    ...
    def test_parse_file_with_multiple_vuln_has_multiple_findings_json(self):
        with (get_unit_tests_scans_path("immuniweb") / "ImmuniWeb-multiple-vuln.json").open(encoding="utf-8") as testfile:
            ...
            self.assertEqual("some-company.com", self.get_unsaved_locations(findings[0])[0].host)
            ...
            self.assertEqual("aai.some-company.com", self.get_unsaved_locations(findings[1])[0].host)
            ...
            self.assertEqual("aai.some-company.com", self.get_unsaved_locations(findings[2])[0].host)
            ...
            self.assertEqual([], self.get_unsaved_locations(findings[4]))
