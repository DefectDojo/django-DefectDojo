...
class TestEdgescanParser(TestCase):
    ...
    def test_parse_file_with_one_vuln_has_one_findings(self):
        with open("unittests/scans/edgescan/one_vuln.json") as testfile:
            ...
            self.assertEqual(finding.cvssv3, "AV:N/AC:H/PR:N/UI:N/S:U/C:N/I:L/A:N")
    ...
    def test_parse_file_with_multiple_vuln_has_multiple_finding(self):
        with open("unittests/scans/edgescan/many_vulns.json") as testfile:
            ...
            self.assertEqual(finding_2.cvssv3, "AV:N/AC:H/PR:N/UI:N/S:U/C:N/I:L/A:N")
            ...
            self.assertEqual(finding_2.tags, None)
