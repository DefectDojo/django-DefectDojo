...
class TestRapidFireParser(TestCase):
    ...
    def test_parse_no_findings(self):
        ...
        with open("unittests/scans/rapidfire/no_vuln.csv") as testfile:
    ...
    def test_parse_one_finding(self):
        ...
        with open("unittests/scans/rapidfire/one_vuln.csv") as testfile:
            parser = RapidFireParser()
            findings = parser.get_findings(testfile, Test())
    ...
    def test_parse_many_findings(self):
        ...
        with open("unittests/scans/rapidfire/many_vulns.csv") as testfile:
            parser = RapidFireParser()
            findings = parser.get_findings(testfile, Test())
    ...
    def test_reference_formatting(self):
        ...
        multiple_refs = ('https://www.cisa.gov/known-exploited-vulnerabilities-catalog,'
    ...
    def test_complex_port_formats(self):
        ...
        with open("unittests/scans/rapidfire/complex_ports.csv") as testfile:
            parser = RapidFireParser()
            findings = parser.get_findings(testfile, Test())
    ...
    def test_invalid_dates(self):
        ...
        with open("unittests/scans/rapidfire/invalid_date.csv") as testfile:
            parser = RapidFireParser()
            findings = parser.get_findings(testfile, Test())
    ...
    def test_impact_formatting(self):
        ...
        expected = (
            ...
            "* **CVE-2023-44487** - [NVD Link](https://nvd.nist.gov/vuln/detail/CVE-2023-44487)"    # Changed here
        )
