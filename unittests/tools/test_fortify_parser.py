...
class TestFortifyParser(DojoTestCase):
    ...
    def test_fortify_few_findings(self):
        testfile = self.unit_test_folder + "/scans/fortify/fortify_few_findings.xml"
        parser = FortifyParser()
        findings = parser.get_findings(testfile, Test())
    ...
    def test_fortify_few_findings_count_chart(self):
        testfile = self.unit_test_folder + "/scans/fortify/fortify_few_findings_count_chart.xml"
        parser = FortifyParser()
        findings = parser.get_findings(testfile, Test())
