...
class TestDependencyTrackParser(TestCase):
    ...
    def test_dependency_track_parser_with_empty_list_for_findings_key_has_no_findings(
        ...
        testfile = open(
            self.unit_test_folder + "/scans/dependency_track_samples/no_findings_because_findings_key_is_empty_list.json"
        )
    ...
    def test_dependency_track_parser_with_missing_findings_key_has_no_findings(self):
        testfile = open(
            self.unit_test_folder + "/scans/dependency_track_samples/no_findings_because_findings_key_is_missing.json"
        )
        parser = DependencyTrackParser()
        findings = parser.get_findings(testfile, Test())
        testfile.close()
    ...
    def test_dependency_track_parser_with_null_findings_key_has_no_findings(self):
        testfile = open(
            self.unit_test_folder + "/scans/dependency_track_samples/no_findings_because_findings_key_is_null.json"
        )
        parser = DependencyTrackParser()
        findings = parser.get_findings(testfile, Test())
        testfile.close()
    ...
    def test_dependency_track_parser_has_many_findings(self):
        testfile = open(
            self.unit_test_folder + "/scans/dependency_track_samples/many_findings.json"
        )
        parser = DependencyTrackParser()
        findings = parser.get_findings(testfile, Test())
        testfile.close()
    ...
    def test_dependency_track_parser_has_one_finding(self):
        testfile = open(
            self.unit_test_folder + "/scans/dependency_track_samples/one_finding.json"
        )
        parser = DependencyTrackParser()
        findings = parser.get_findings(testfile, Test())
        testfile.close()
    ...
    def test_dependency_track_parser_v3_8_0(self):
        testfile = open(
            self.unit_test_folder + "/scans/dependency_track_samples/dependency_track_3.8.0_2021-01-18.json"
        )
        parser = DependencyTrackParser()
        findings = parser.get_findings(testfile, Test())
        testfile.close()
