...
class TestNetsparkerParser(DojoTestCase):
    ...
    def test_parse_file_with_one_finding(self):
        with open(get_unit_tests_scans_path("netsparker") / "netsparker_one_finding.json", encoding="utf-8") as testfile:
    ...
    def test_parse_file_with_multiple_finding(self):
        with open(get_unit_tests_scans_path("netsparker") / "netsparker_many_findings.json", encoding="utf-8") as testfile:
            parser = NetsparkerParser()
            findings = parser.get_findings(testfile, Test())
    ...
    def test_parse_file_issue_9816(self):
        with open(get_unit_tests_scans_path("netsparker") / "issue_9816.json", encoding="utf-8") as testfile:
            parser = NetsparkerParser()
            findings = parser.get_findings(testfile, Test())
    ...
    def test_parse_file_issue_10311(self):
        with open(get_unit_tests_scans_path("netsparker") / "issue_10311.json", encoding="utf-8") as testfile:
            parser = NetsparkerParser()
            findings = parser.get_findings(testfile, Test())
            self.assertEqual(3, len(findings))
            for finding in findings:
    ...
    def test_parse_file_issue_11020(self):
        with open(get_unit_tests_scans_path("netsparker") / "issue_11020.json", encoding="utf-8") as testfile:
            parser = NetsparkerParser()
            findings = parser.get_findings(testfile, Test())
            self.assertEqual(3, len(findings))
            for finding in findings:
