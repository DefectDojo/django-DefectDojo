...
class TestOssIndexDevauditParser(DojoTestCase):
    ...
    def test_ossindex_devaudit_parser_with_no_vulns_has_no_findings(self):
        testfile = open(
            self.unit_test_folder + "/scans/ossindex_devaudit_sample/ossindex_devaudit_no_vuln.json"
        )
    ...
    def test_ossindex_devaudit_parser_with_one_critical_vuln_has_one_finding(self):
        testfile = open(
            self.unit_test_folder + "/scans/ossindex_devaudit_sample/ossindex_devaudit_one_vuln.json"
        )
        parser = OssIndexDevauditParser()
        findings = parser.get_findings(testfile, Test())
        testfile.close()
    ...
    def test_ossindex_devaudit_parser_with_multiple_vulns_has_multiple_finding(self):
        testfile = open(
            self.unit_test_folder + "/scans/ossindex_devaudit_sample/ossindex_devaudit_multiple_vulns.json"
        )
        parser = OssIndexDevauditParser()
        findings = parser.get_findings(testfile, Test())
        testfile.close()
    ...
    def test_ossindex_devaudit_parser_with_no_cve_returns_info_severity(self):
        testfile = open(
            self.unit_test_folder + "/scans/ossindex_devaudit_sample/ossindex_devaudit_vuln_no_cvssscore.json"
        )
        parser = OssIndexDevauditParser()
        findings = parser.get_findings(testfile, Test())
        testfile.close()
    ...
    def test_ossindex_devaudit_parser_with_empty_reference_shows_empty_reference(self):
        testfile = open(
            self.unit_test_folder + "/scans/ossindex_devaudit_sample/ossindex_devaudit_empty_reference.json"
        )
        parser = OssIndexDevauditParser()
        findings = parser.get_findings(testfile, Test())
        testfile.close()
    ...
    def test_ossindex_devaudit_parser_with_missing_reference_shows_empty(self):
        testfile = open(
            self.unit_test_folder + "/scans/ossindex_devaudit_sample/ossindex_devaudit_missing_reference.json"
        )
        parser = OssIndexDevauditParser()
        findings = parser.get_findings(testfile, Test())
        testfile.close()
    ...
    def test_ossindex_devaudit_parser_with_missing_cwe_shows_1035(self):
        testfile = open(
            self.unit_test_folder + "/scans/ossindex_devaudit_sample/ossindex_devaudit_missing_cwe.json"
        )
        parser = OssIndexDevauditParser()
        findings = parser.get_findings(testfile, Test())
        testfile.close()
    ...
    def test_ossindex_devaudit_parser_with_null_cwe_shows_1035(self):
        testfile = open(
            self.unit_test_folder + "/scans/ossindex_devaudit_sample/ossindex_devaudit_null_cwe.json"
        )
        parser = OssIndexDevauditParser()
        findings = parser.get_findings(testfile, Test())
        testfile.close()
    ...
    def test_ossindex_devaudit_parser_with_empty_cwe_shows_1035(self):
        testfile = open(
            self.unit_test_folder + "/scans/ossindex_devaudit_sample/ossindex_devaudit_empty_cwe.json"
        )
        parser = OssIndexDevauditParser()
        findings = parser.get_findings(testfile, Test())
        testfile.close()
    ...
    def test_ossindex_devaudit_parser_get_severity_shows_info(self):
        testfile = open(
            self.unit_test_folder + "/scans/ossindex_devaudit_sample/ossindex_devaudit_severity_info.json"
        )
        parser = OssIndexDevauditParser()
        findings = parser.get_findings(testfile, Test())
        testfile.close()
    ...
    def test_ossindex_devaudit_parser_get_severity_shows_critical(self):
        testfile = open(
            self.unit_test_folder + "/scans/ossindex_devaudit_sample/ossindex_devaudit_severity_critical.json"
        )
        parser = OssIndexDevauditParser()
        findings = parser.get_findings(testfile, Test())
        testfile.close()
    ...
    def test_ossindex_devaudit_parser_get_severity_shows_high(self):
        testfile = open(
            self.unit_test_folder + "/scans/ossindex_devaudit_sample/ossindex_devaudit_severity_high.json"
        )
        parser = OssIndexDevauditParser()
        findings = parser.get_findings(testfile, Test())
        testfile.close()
    ...
    def test_ossindex_devaudit_parser_get_severity_shows_medium(self):
        testfile = open(
            self.unit_test_folder + "/scans/ossindex_devaudit_sample/ossindex_devaudit_severity_medium.json"
        )
        parser = OssIndexDevauditParser()
        findings = parser.get_findings(testfile, Test())
        testfile.close()
    ...
    def test_ossindex_devaudit_parser_get_severity_shows_low(self):
        testfile = open(
            self.unit_test_folder + "/scans/ossindex_devaudit_sample/ossindex_devaudit_severity_low.json"
        )
        parser = OssIndexDevauditParser()
        findings = parser.get_findings(testfile, Test())
        testfile.close()
