...
class TestBulkRiskAcceptanceApi(APITestCase):
    ...
    def test_finding_accept_risks(self):
        ...
        self.assertEqual(self.engagement_2a.product.risk_acceptances.count(), 0, self.engagement_2a.product.risk_acceptances)
        self.assertEqual(self.engagement_2a.unaccepted_open_findings.count(), 34, self.engagement_2a.unaccepted_open_findings)
