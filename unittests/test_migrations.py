...
# TODO: These tests can be skipped in 2.12.x or later
# @skip("Outdated - Any future changes of code should not affect these tests")
class TestOptiEndpointStatus(MigratorTestCase):
    migrate_from = ('dojo', '0160_set_notnull_endpoint_statuses')
    migrate_to = ('dojo', '0161_optimize_usage_of_endpoint_status')
