...
FINDING_2 = {"id": 5, "title": "High Impact Test Finding", "date": date(2018, 1, 1), "sla_start_date": None, "sla_expiration_date": None, "cwe": None, "cve": None, "epss_score": None, "epss_percentile": None, "cvssv3": None, "cvssv3_score": None, "url": None, "severity": "High", "description": "test finding", "mitigation": "test mitigation", "impact": "High", "steps_to_reproduce": None, "severity_justification": None, "references": "", "test_id": 3, "active": True, "verified": False, "false_p": False, "duplicate": True, "duplicate_finding_id": 2, "out_of_scope": False, "risk_accepted": True, "under_review": False, "last_status_update": None, "review_requested_by_id": 1, "under_defect_review": False, "defect_review_requested_by_id": 1, "is_mitigated": False, "thread_id": 11, "mitigated": None, "mitigated_by_id": None, "reporter_id": 1, "numerical_severity": "S0", "last_reviewed": None, "last_reviewed_by_id": None, "param": None, "payload": None, "hash_code": "5d368a051fdec959e08315a32ef633ba5711bed6e8e75319ddee2cab4d4608c7", "line": None, "file_path": "", "component_name": None, "component_version": None, "static_finding": False, "dynamic_finding": False, "created": datetime(2017, 12, 1, 0, 0, tzinfo=timezone.utc), "scanner_confidence": None, "sonarqube_issue_id": None, "unique_id_from_tool": None, "vuln_id_from_tool": None, "sast_source_object": None, "sast_sink_object": None, "sast_source_line": None, "sast_source_file_path": None, "nb_occurences": None, "publish_date": None, "service": None, "planned_remediation_date": None, "planned_remediation_version": None, "effort_for_fixing": None, "test__engagement__product__prod_type__member": False, "test__engagement__product__member": True, "test__engagement__product__prod_type__authorized_group": False, "test__engagement__product__authorized_group": False}
...
ALL_FINDINGS = [FINDING_1, FINDING_2, FINDING_3, FINDING_4, FINDING_5, FINDING_6, FINDING_7]
CLOSED_FINDINGS = [FINDING_4]
ACCEPTED_FINDINGS = [FINDING_2, FINDING_3, FINDING_4]
            ...
            self.assertEqual(
                finding_queries["monthly_counts"],
                {
                    "opened_per_period": [
                        ...
                        {"epoch": 1512086400000, "grouped_date": date(2017, 12, 1), "critical": 0, "high": 1, "medium": 0, "low": 0, "info": 0, "total": 1, "closed": 1},
                        {"epoch": 1514764800000, "grouped_date": date(2018, 1, 1), "critical": 0, "high": 3, "medium": 0, "low": 3, "info": 0, "total": 6, "closed": 0},
                    ],
                    "active_per_period": [
                        ...
                        {"epoch": 1514764800000, "grouped_date": date(2018, 1, 1), "critical": 0, "high": 3, "medium": 0, "low": 0, "info": 0, "total": 3},
                    ],
                    "accepted_per_period": [
                        {"epoch": 1509494400000, "grouped_date": date(2017, 11, 1), "critical": 0, "high": 0, "medium": 0, "low": 0, "info": 0, "total": 0},
            ...
            self.assertEqual(
                finding_queries["weekly_counts"],
                {
                    "opened_per_period": [
                        ...
                        {"epoch": 1514160000000, "grouped_date": date(2017, 12, 25), "critical": 0, "high": 1, "medium": 0, "low": 0, "info": 0, "total": 1, "closed": 1},
                        {"epoch": 1514764800000, "grouped_date": date(2018, 1, 1), "critical": 0, "high": 3, "medium": 0, "low": 3, "info": 0, "total": 6, "closed": 0},
                    ],
                    "active_per_period": [
