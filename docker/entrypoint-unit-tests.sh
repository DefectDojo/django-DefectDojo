...
python3 manage.py test unittests -v 3 --keepdb --no-input --failfast --shuffle --parallel --exclude-tag="non-parallel,transactional" || {
    exit 1;
}
python3 manage.py test unittests -v 3 --keepdb --no-input --failfast --shuffle --tag="non-parallel" || {
    exit 1;
}
python3 manage.py test unittests -v 3 --keepdb --no-input --failfast --shuffle --tag="transactional" || {
    exit 1;
}
