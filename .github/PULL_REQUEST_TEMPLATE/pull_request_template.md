...
- [ ] If this is a new feature and not a bug fix, you've included the proper documentation in the documentation folder. https://github.com/DefectDojo/django-DefectDojo/tree/dev/docs or provide feature documentation in the PR.
